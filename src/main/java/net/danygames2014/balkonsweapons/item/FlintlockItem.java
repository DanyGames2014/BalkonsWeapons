...
public class FlintlockItem extends RangedItem{
    public FlintlockItem(Identifier identifier) {
        super(identifier, RangedSpecs.FLINTLOCK);
    }
...
//        entityliving.swingItem();
    ...
    public void fire(ItemStack stack, World world, LivingEntity entity, int i) {
        ...
        if (!world.isRemote) {
            ...
            musketBulletEntity.setAim(entity, entity.pitch, entity.yaw, 0.0f, 5.0f,
                    4.0f / f);
            musketBulletEntity.setExtraDamage(musketBulletEntity.extraDamage - 10.0f);
